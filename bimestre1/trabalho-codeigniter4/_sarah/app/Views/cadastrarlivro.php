  ...
  <body>
    ...
    <main class="d-flex text-center flex-lg-column">
      <div class="div">
        ...
        <form action="/cadastrarlivro" method="post" class="d-flex text-center flex-lg-column">
          <label for="autores" class="mt-3">Autores</label>
          <input type="text" name="autores" id="autores" class="form-control w-50 mt-1">

          <label for="titulo" class="mt-3">Título</label>
          <input type="text" name="titulo" id="titulo" class="form-control w-50 mt-1">

          <label for="ano" class="mt-3">Ano</label>
          <input type="number" name="ano" id="ano" class="form-control w-50 mt-1">

          <label for="editora" class="mt-3">Editora</label>
          <input type="text" name="editora" id="editora" class="form-control w-50 mt-1">

          <label for="disponivel" class="mt-3">Cópias disponíveis</label>
          <input type="number" name="disponivel" id="disponivel" class="form-control w-50 mt-1">
